            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-left">
                        <li>
                            <a href=""  onclick="loadFile('home.html'); return false;">Home</a>
                        </li>
                        <li>
                            <a href="" onclick="loadFile('about.html'); return false;">About</a>
                        </li>
                        <li>
                            <a href="" onclick="loadFile('contact.html'); return false;">Contact</a>
                        </li>
                    </ul>
                    <ul class="nav navbar-nav navbar-right"	>
                        <li >
                            <a href="" onclick="loadFile('login3.html'); return false;">Login | Register </a>
                        </li>
